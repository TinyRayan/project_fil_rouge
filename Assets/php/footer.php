        ...
        <footer>
            ...
            <ul class="list-inline mt-2 d-flex justify-content-around   ">
             ...
             <div class="social d-flex justify-content-evenly ">
              ...
              <a href="#"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="30" height="30" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
            ...
            <p class="copyright mt-3 d-flex justify-content-center ">The District © 2024</p>
        </footer>
    </div>
